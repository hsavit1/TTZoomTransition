...
// TTZoomTransition
#define COCOAPODS_POD_AVAILABLE_TTZoomTransition
#define COCOAPODS_VERSION_MAJOR_TTZoomTransition 1
#define COCOAPODS_VERSION_MINOR_TTZoomTransition 0
#define COCOAPODS_VERSION_PATCH_TTZoomTransition 0
